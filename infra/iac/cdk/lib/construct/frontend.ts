 ...
 * 認証情報。
 *
 * @property authSecret - フロントエンドのNextjs(Auth.js)で用いるシークレット値
 * @property authTypetalkId - Typetalk OAuthのID
 * @property authTypetalkSecret - Typetalk OAuthのシークレット
 * @property frontendApiSecretKey - フロントエンドAPIのシークレットキー
 * @property basicAuthEncoded - Basic認証のエンコード済み文字列
 */
