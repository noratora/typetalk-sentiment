...
export const systemParameter: SystemParameter = {
  ...
  // TODO [設定必須]: Route53で管理する独自ドメインを設定してください
...
export const devParameter: AppParameter = {
  ...
  baseDomainName: systemParameter.baseDomainName,
  targetEnv: "dev",
  envName: "Dev",
  domainName: "dev." + systemParameter.baseDomainName,
  pipelineConfig: {
  ...
  frontendConfig: {
    apiFunction: {
      ...
      buildArgs: {
        ...
        allowedOrigins: `dev.${systemParameter.baseDomainName},*.dev.${systemParameter.baseDomainName}`,
      },
      environment: {
        logLevel: "info",
      },
...
export const prodParameter: AppParameter = {
  ...
  targetEnv: "prod",
  envName: "Prod",
  domainName: systemParameter.baseDomainName,
  pipelineConfig: {
  ...
  frontendConfig: {
    apiFunction: {
      ...
      buildArgs: {
        imagesRemotePatterns:
          '[{ "protocol": "https", "hostname": "typetalk.com" },{ "protocol": "https", "hostname": "apps.nulab.com" }]',
        allowedOrigins: `${systemParameter.baseDomainName},*.${systemParameter.baseDomainName}`,
      },
      environment: {
        logLevel: "info",
      },
